...
Visible bool is_tlt(v) value v; {
	literal t= Type(v);
	return t == Tex || t == Lis || t == Tab || t == ELT;
}
...
Visible value th_of(n, t) value n, t; {
	return thof(propintlet(intval(n)), t);
}

Visible value thof(n, t) intlet n; value t; {
...
Visible bool in(v, t) value v, t; {
	...
	case Tab:
		Over(t) if (compare(v, Dts(*tp++)) == 0) return Yes;
		return No;
	default:
